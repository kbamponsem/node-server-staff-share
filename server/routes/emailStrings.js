const confirmationEmailString = (url, name) => {
    return `
...
@media only screen and (max-width:480px) {
  ...
  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
    <div style="text-align: center;"><span style="font-size: 48px;">Welcome to StaffShare</span></div>
  </div>
  ...
  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
    <p><span style="font-size: 24px;">Hey ${name},</span></p>
  </div>
  ...
  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
    <p><span style="font-size: 14px;">Thank you for registering for a StaffShare account! We are glad that you joined our community. We just need to verify your email. Click below to verify your email.</span></p>
  </div>
        ...
        <tr>
          <td align="center" vertical-align="middle" style="font-size:0px;padding:25px 25px 25px 25px;word-break:break-word;">
            
  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
    <tbody><tr>
      <td align="center" bgcolor="#417505" role="presentation" style="border:0px solid #000;border-radius:5px;cursor:auto;mso-padding-alt:10px 30px 10px 30px;background:#417505;" valign="middle">
        <a href=${url} style="display:inline-block;background:#417505;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;line-height:100%;Margin:0;text-decoration:none;text-transform:none;padding:10px 30px 10px 30px;mso-padding-alt:0px;border-radius:5px;" target="_blank">
...
module.exports = confirmationEmailString;
